...
of HTTP headers. In the process, I learned about how URLs work, domain names,
...
NOTE: The `curl` behaviour in all Bash scripts was written to interact with a
...
* **9. Catch me if you can!**
  * [102-catch_me.sh](./102-catch_me.sh): Bash script that sends a request to
  `0.0.0.0:5000/catch_me` causes the server to respond with a message
